...
I'm Thomas van Dongen. I'm head of AI engineering at [Springer Nature](https://www.springernature.com/gp) and co-founder of [Minish](https://github.com/MinishLab), an open-source NLP lab working on efficient models and packages.
...
- [semhash](https://github.com/MinishLab/semhash): a library for multimodal deduplication, outlier detection, and representative filtering.
- [pyversity](https://github.com/Pringled/pyversity): a library for retrieval result diversification.
- [semble](https://github.com/MinishLab/semble): a code-search MCP/CLI tool for agents that drastically reduces token consumption.
